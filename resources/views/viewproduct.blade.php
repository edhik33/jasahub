            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="">Home</a> <span class="mx-2 mb-0">/</span>
                        <strong class="text-black">Illustrator</strong>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>menciptakan karya seni dengan menggunakan perangkat elektronik, seperti komputer, tablet,
                            atau ponsel pintar. Mereka menggunakan perangkat lunak desain grafis untuk menggambar,
                            mewarnai, dan menambahkan efek </p>
