                    ...
                    <div class="hero-inner">
                        <div class="hero-copy">
                            ...
                            <p class="hero-paragraph">
                                Dengan JasaHub, platform freelance revolusioner kami, temukan keleluasaan dan kenyamanan
                                dalam menjalankan proyek-proyek freelance Anda. Hubungkan diri Anda dengan ribuan
                                profesional berbakat dan pemberi proyek yang mencari keahlian Anda. Nikmati pengalaman
                                berfreelance yang lebih efisien dan transparan dengan fitur-fitur inovatif kami.
                                Bergabunglah dengan JasaHub hari ini dan temukan dunia baru di mana bakat dan peluang
                                berkumpul dalam satu tempat!
                            </p>
                            <div class="hero-cta">
                                @if(Auth::check())
                                <a class="button button-primary" href="{{ route('dashboard') }}">Go to Dashboard</a>
                                @else
                        ...
                        <div class="hero-media">
                            ...
                            <div class="hero-media-container">
                                <img class="hero-media-image asset-light" src="dist/images/gambar 2.jpg"
                                    alt="Hero media" style="width: 75%">
                                {{-- <img class="hero-media-image asset-light" src="dist/images/hero-media-light.svg"
                                    alt="Hero media"> --}}
                                <img class="hero-media-image asset-dark" src="dist/images/gambar 2.jpg" alt="Hero media"
                                    style="width: 75%">
                        ...
                        <div class="features-header text-center">
                            <div class="container-sm">
                                ...
                                <p class="section-paragraph">
                                    JasaHub, seperti peluk hangat mentari di tengah ladang kreativitas, tempat di mana
                                    ide-ide bersinar seperti bintang-bintang malam. Sebuah aliran inspirasi yang
                                    mengalir bebas, menghubungkan bakat-bakat gemilang dengan peluang emas, seakan-akan
                                    menjadi simfoni keberhasilan di antara jutaan galaksi aspirasi.
                                </p>
                                <div class="features-image">
                                    <img class="features-illustration asset-dark"
                                        src="dist/images/features-illustration-dark.svg" alt="Feature illustration">
                                    <img class="features-box asset-dark" src="dist/images/gambar 1.jpg"
                                        alt="Feature box">
                                    <img class="features-illustration asset-dark"
                                    ...
                                    <img class="features-box asset-light" src="dist/images/gambar 1.jpg"
                                        alt="Feature box">
                                    <img class="features-illustration asset-light"
                            ...
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <div class="feature-content">
                                        ...
                                        <p class="text-sm mb-0">Sustainable economic growth serves as the key to
                                            fostering societal well-being and elevating the global standard of living.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <div class="feature-content">
                                        ...
                                        <p class="text-sm mb-0">Sustainable growth serves as the foundation for progress
                                            and evolution, bringing positive benefits to both individuals and society.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <div class="feature-content">
                                        ...
                                        <p class="text-sm mb-0">Growth is a natural process that brings about change and
                                            opportunities, creating a foundation for development and sustainability.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                                        <div class="block-4 text-center border">
                                            ...
                                            <div class="block-4-text p-4">
                                                <h3><a
                                                        href="{{ route('detail-product.show', $product->slug) }} $product->title }}"></a>
                                                </h3>
                    ...
                    <div class="container-sm">
                        <div class="cta-inner section-inner">
                            <div class="cta-header text-center">
                                ...
                                <p class="section-paragraph">Economic growth doesn't mean anything if it leaves people
                                    out
                                </p>
                                <div class="cta-cta">
                                    <a class="button button-primary" href="{{route('register')}}">Registration</a>
                                </div>
                            </div>
                        </div>
                    </div>
